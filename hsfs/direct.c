...
/* qinping mod 20060331 begin */
static int
nfs_direct_io_get_blocks(struct inode *inode, sector_t iblock, unsigned long max_blocks,
		struct buffer_head *bh_result, int create)
{
	int ret;
	ret = nfs_get_block(inode, iblock, bh_result, create);
...
/*
	...
	return blockdev_direct_IO(rw, iocb, inode, inode->i_sb->s_bdev, iov,
				pos, nr_segs,
				nfs_direct_io_get_blocks, NULL);
*/	
	return blockdev_direct_IO(rw, iocb, inode, NULL, iov, pos, nr_segs, nfs_direct_io_get_blocks, NULL);
...
{
        nfs_direct_cachep = kmem_cache_create("enfs_direct_cache",
