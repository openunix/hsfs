...
#include <linux/in.h>
/*zhangdazhi mod 20060910 begin*/
/*nfs.h should before mm.h to really take effective*/
#include "nfs.h"
/*zhangdazhi mod 20060910 end*/
#include <linux/mm.h>
...
/* zhangdazhi add 20060825 begin */
#ifdef CONFIG_NFS_ACL
#undef CONFIG_NFS_ACL
#endif
/* zhangdazhi add 20060825 end */

#ifndef CONFIG_NFS_DIRECTIO
#define CONFIG_NFS_DIRECTIO
#endif
...
struct nfs_inode {
	...
	/* qinping mod 20060331 begin */
	struct semaphore	m_sem;		/* bcache */
	unsigned int		victim;		/* bcache */
	unsigned int		mru;		/* bcache */
	struct bcache		pbcache;	/* bcache */

	struct list_head	attrset;		/* setattr */
	unsigned long		attrset_timeout;	/* setattr */
...
/* qinping mod 20060331 begin */
#define ATTR_WRITE		16384	/* when happen write operation, set the flags */
#define ATTR_BFLUSHD		32768	/* setting attrs for bflushd */
#define NFS_INO_SETTING		0x4000	/* inode size is setting */
#define NFS_INO_SYNC_SIZE	0x8000	/* inode size is not sync */
/* qinping mod 20060331 end */
...
/* qinping mod 20060331 begin */
#define NFS_MAPSEM(inode)		(NFS_I(inode)->m_sem)
#define NFS_ATTRSET(inode)		(NFS_I(inode)->attrset)
#define NFS_ATTRSET_TIMEOUT(inode)	(NFS_I(inode)->attrset_timeout)
...
#define NFS_GET_BLOCK_TEST
struct enfs_bcache_stat_t
{
	int     flag;
};

extern struct enfs_bcache_stat_t bcache_stat;
#define BCACHE_STAT bcache_stat.flag
extern void enfs_invalidate_inode(struct inode *);
#endif
/* qinping mod 20060331 end */
...
/* qinping mod 20060331 begin */
extern void inode_attrset_insert(struct inode *);
extern void inode_attrset_del(struct inode *);
extern int inode_attrset_do(struct dentry *, int);
extern int inode_attrset_do_nolock(struct dentry *);
/* qinping mod 20060331 end */
...
nfs_have_writebacks(struct inode *inode)
{
	/* qinping mod 20060331 begin */
	if (1)
		return (NFS_FLAGS(inode) & (NFS_INO_SETTING | NFS_INO_SYNC_SIZE));
	else
	/* qinping mod 20060331 end */
...
/* qinping mod 20060331 begin */
extern void enfs_check_bcache(struct inode *, loff_t);
extern void enfs_init_bcache(struct inode *);
extern int nfs_get_block(struct inode *, sector_t, struct buffer_head *, int);
/* qinping mod 20060331 end */
