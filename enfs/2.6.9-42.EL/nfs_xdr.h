...
/* qinping mod 20060331 begin */
#define ENFS_CACHE_SECTS 6
struct bcache {
	__u64			index_off[ENFS_CACHE_SECTS];
	__u64			bnr_off[ENFS_CACHE_SECTS];
	int			count[ENFS_CACHE_SECTS];
};

struct nfs3_getblksargs {
	struct nfs_fh		*fh;
	__u64			offset;
	__u32			count;
	__u32			create;
...
struct nfs_rpc_ops {
	...
	/* qinping mod 20060331 begin */
	int	(*getblks)(struct inode *, loff_t, unsigned int, int, struct nfs3_bcache *);
	/* qinping mod 20060331 end */
};
